...
class TourContinent extends Model {
    ...
    //     return $this->hasMany(\App\Models\RelationTourLocation::class, 'tour_continent_id', 'id');
    // }
    ...
    //     return $this->hasMany(\App\Models\RelationTourLocationAirLocation::class, 'tour_continent_id', 'id');
    // }
