                    ...
                    <tr id="item-{{ $item->id }}">
                        ...
                        <td style="vertical-align:top;display:flex;">
                            <div class="icon-wrapper iconAction">
                                <a href="{{ route('admin.partner.viewEdit', ['id' => $item->id]) }}">
                                    <i data-feather='edit'></i>
                                    <div>Sửa</div>
                                </a>
                            </div>
                            <div class="icon-wrapper iconAction">
                                <a href="{{ route('admin.partner.viewEdit', ['id' => $item->id, 'type' => 'copy']) }}">
...
<!-- Nút thêm -->
<a href="{{ route('admin.partner.viewInsert') }}" class="addItemBox">
