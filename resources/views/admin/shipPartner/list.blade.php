                ...
                @if(!empty($list)&&$list->isNotEmpty())
                    ...
                    <tr id="item-{{ $item->id }}">
                        ...
                        <td style="vertical-align:top;display:flex;">
                            ...
                            <div class="icon-wrapper iconAction">
                                <a href="{{ route('admin.shipPartner.view', ['id' => $item->id, 'type' => 'copy']) }}">
...
<!-- Nút thêm -->
<a href="{{ route('admin.shipPartner.view') }}" class="addItemBox">
    ...
    <script type="text/javascript">
        function deleteItem(id){
            if(confirm('{{ config("admin.alert.confirmRemove") }}')) {
                $.ajax({
                    url         : "{{ route('admin.shipPartner.delete') }}",
                    type        : "GET",
                    dataType    : "html",
                    data        : { id : id }
                }).done(function(data){
