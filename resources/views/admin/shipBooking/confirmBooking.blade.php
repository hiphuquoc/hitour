                                    ...
                                    <tbody>
                                        ...
                                        @if(!empty($item->customer->email))
                                            <tr>
                                                ...
                                                <td style="font-weight:bold;font-size:15px;padding:5px;">{{ $item->customer->email }}</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="border-bottom:1px dotted #d1d1d1;color:#456;">
                                            <td style="padding:5px;">
                                                ...
                                                @endphp
                                                <div>
                                                    2. Quý khách chuyển khoản theo thông tin bên dưới <span style="font-weight:bold;font-size:16px;">{{ $deadline }}</span>, trong nội dung chuyển khoản ghi <span style="font-weight:bold;font-size:16px;">{{ $item->customer->phone }}</span>
                                                </div>
                                                @php
