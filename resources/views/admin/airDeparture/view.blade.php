...
@section('content')
    @php
        $titlePage      = 'Thêm điểm khởi hành Vé máy bay mới';
        $submit         = 'admin.airDeparture.create';
        $checkImage     = 'required';
        if(!empty($type)&&$type=='edit'){
            $titlePage  = 'Chỉnh sửa điểm khởi hành Vé máy bay';
            $submit     = 'admin.airDeparture.update';
            $checkImage = null;
        }
    @endphp
            ...
            <div class="pageAdminWithRightSidebar_main">
                    ...
                    <div class="pageAdminWithRightSidebar_main_content_item">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @include('admin.airDeparture.formPage')
                ...
                <div class="pageAdminWithRightSidebar_main_rightSidebar">
                    ...
                    <div class="pageAdminWithRightSidebar_main_rightSidebar_item buttonAction" style="padding-bottom:1rem;">
                        <a href="{{ route('admin.airDeparture.list') }}" type="button" class="btn btn-secondary waves-effect waves-float waves-light">Quay lại</a>
