...
@section('content')
    @php
        $titlePage      = 'Thêm điểm khởi hành Tour mới';
        $submit         = 'admin.tourDeparture.create';
        $checkImage     = 'required';
        if(!empty($type)&&$type=='edit'){
            $titlePage  = 'Chỉnh sửa điểm khởi hành Tour';
            $submit     = 'admin.tourDeparture.update';
            $checkImage = null;
        }
    @endphp
                    ...
                    <div class="pageAdminWithRightSidebar_main_content_item">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @include('admin.tourDeparture.formPage')
