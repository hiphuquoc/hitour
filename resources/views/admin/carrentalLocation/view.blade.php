...
@section('content')
    @php
        $titlePage      = 'Thêm Cho thuê xe mới';
        $submit         = 'admin.carrentalLocation.create';
        $checkImage     = 'required';
        if(!empty($type)&&$type=='edit'){
            $titlePage  = 'Chỉnh sửa Cho thuê xe';
            $submit     = 'admin.carrentalLocation.update';
            $checkImage = null;
        }
    @endphp
            ...
            <div class="pageAdminWithRightSidebar_main">
                    ...
                    <div class="pageAdminWithRightSidebar_main_content_item">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @include('admin.carrentalLocation.formPage')
                ...
                <div class="pageAdminWithRightSidebar_main_rightSidebar">
                    ...
                    <div class="pageAdminWithRightSidebar_main_rightSidebar_item buttonAction" style="padding-bottom:1rem;">
                        <a href="{{ route('admin.carrentalLocation.list') }}" type="button" class="btn btn-secondary waves-effect waves-float waves-light">Quay lại</a>
