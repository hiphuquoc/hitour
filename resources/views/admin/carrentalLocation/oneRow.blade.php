...
@php
    $no = $no ?? 0;
@endphp
<tr id="carrentalLocation_{{ $item->id ?? 0 }}">
    ...
    <td style="vertical-align:top;display:flex;font-size:0.95rem;">
        ...
        @endif
        <div class="icon-wrapper iconAction">
            <a href="{{ route('admin.carrentalLocation.view', ['id' => $item->id ?? 0, 'type' => 'edit' ]) }}">
                <i data-feather='edit'></i>
                <div>Sửa</div>
            </a>
        </div>
        <div class="icon-wrapper iconAction">
            <a href="{{ route('admin.carrentalLocation.view', ['id' => $item->id ?? 0, 'type' => 'copy']) }}">
