...
<div class="titlePage">Danh sách Điểm đến Tàu</div>
<!-- ===== START: SEARCH FORM ===== -->
<form id="formSearch" method="get" action="{{ route('admin.shipLocation.list') }}">
    <div class="searchBox">
...
<!-- Nút thêm -->
<a href="{{ route('admin.shipLocation.view') }}" class="addItemBox">
