...
<!-- ===== START: SEARCH FORM ===== -->
<form id="formSearch" method="get" action="{{ route('admin.tourPartner.list') }}">
    <div class="searchBox">
        ...
        <div class="searchBox_item" style="margin-left:auto;text-align:right;">
            <?php
                $xhtmlSettingView   = \App\Helpers\Setting::settingView('viewTourPartner', [20, 50, 100, 200, 500], $viewPerPage, $list->total());
