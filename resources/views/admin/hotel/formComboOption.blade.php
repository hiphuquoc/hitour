<!-- Input hidden -->
<input type="hidden" id="hotel_option_id" name="hotel_option_id" value="{{ $option['hotel_option_id'] ?? null }}" />
<div class="formBox">
    <div class="formBox_full">
        ...
        <!-- One Row -->
        <div class="formBox_full_item">
            <label class="form-label inputRequired" for="hotel_option">Option</label>
            <input type="text" class="form-control" id="hotel_option" name="name" value="{{ $option['name'] ?? null }}" required>
        </div>
        <!-- One Row -->
        <div class="formBox_full_item">
            <div class="flexBox">
