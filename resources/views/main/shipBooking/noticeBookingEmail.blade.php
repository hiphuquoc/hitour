            ...
            <table class="sendEmail" role="presentation" style="border-collapse:collapse;background:#ffffff;border-radius:3px;width:100%;max-width:640px;margin:20px auto;box-shadow:0 0 10px #e9ecef;">
                ...
                <tr>
                    <td style="box-sizing:border-box;text-align:center;line-height:1.68;color:#456;padding:10px 15px 0 15px;">
                        ...
                        <div style="text-align:right;margin-right:10px;font-size:15px;">Đặt lúc 07:20 Thứ 7, 30/07/2022</div>
                    </td>
                </tr>
                <tr>
                    <td style="box-sizing:border-box;padding:10px 15px">
                        <table class="sendEmail" role="presentation" style="border-collapse:collapse;width:100%;font-size:15px;line-height:1.68;color:#456">
                            ...
                            <tr>
                                ...
                                <td style="padding:5px;font-weight:bold;color:rgba(0,123,255,1);font-size:20px;">D728DHN7EE</td>
                            </tr>
                            <tr>
                                <td style="font-size:15px;padding:5px;">Tên khách hàng</td>
                                <td style="font-weight:bold;font-size:15px;padding:5px;">Phạm Thị Minh Thu</td>
                            </tr>
                            <tr>
                                <td style="font-size:15px;padding:5px;">Điện thoại</td>
                                <td style="font-weight:bold;font-size:15px;padding:5px;">0972716251 (Zalo)</td>
                            </tr>
                            <tr>
                                <td style="font-size:15px;padding:5px;">Email</td>
                                <td style="font-weight:bold;font-size:15px;padding:5px;">phamthiminhthu@gmail.com</td>
                            </tr>
                            </tbody>
                        </table>
                    </td>
                    ...
                    <td style="box-sizing:border-box;padding:5px 15px;">
                        <table class="sendEmail" role="presentation" style="border-collapse:collapse;width:100%;line-height:1.68;font-size:15px;color:#456;">
                            ...
                            <tr>
                                ...
                                <td style="font-size:15px;padding:5px;">Tour Phú Quốc 2 ngày 1 đêm</td>
                            </tr>
                            <tr style="border-top:1px dotted #d1d1d1">
                                <td style="width:140px;font-size:15px;padding:5px;">Ngày</td>
                                <td style="font-size:15px;padding:5px;">16/08/2022 - 17/08/2022</td>
                            </tr>
                            <tr style="border-top:1px dotted #d1d1d1">
                                <td style="width:140px;font-size:15px;padding:5px;">Tiêu chuẩn</td>
                                <td style="font-size:15px;padding:5px;">Khách sạn MINI</td>
                            </tr>
                            <tr style="border-top:1px dotted #d1d1d1;">
                                <td style="width:140px;font-size:15px;padding:5px;">Lịch trình</td>
                                <td style="font-size:15px;padding:5px;">
                                    <a href="https://hitour.com/tour-du-lich-phu-quoc/tour-phu-quoc-2-ngay-1-dem" style="color:rgba(0,123,255,1);text-decoration:none" target="_blank">https://hitour.com/tour-du-lich-phu-quoc/tour-phu-quoc-2-ngay-1-dem</a>
                                </td>
                            </tr>
                            <tr style="border-top:1px dotted #d1d1d1">
                                <td style="width:140px;font-size:15px;padding:5px;">Điểm đón</td>
                                <td style="font-size:15px;padding:5px;">Khách sạn</td>
                            </tr>
                            <tr style="border-top:1px dotted #d1d1d1">
                    ...
                    <td style="box-sizing:border-box;padding:5px 15px;">
                        <table class="sendEmail" role="presentation" style="border-collapse:collapse;width:100%;line-height:1.68;font-size:15px;color:#456;border:1px solid #d1d1d1;">
                            ...
                            <tr>
                                ...
                                <td style="font-size:15px;padding:5px 10px;text-align:right;border-left:1px dashed #d1d1d1;border-top:1px dashed #d1d1d1;">2 * 2,250,000</td>
                                <td style="font-size:15px;padding:5px 10px;text-align:right;border-left:1px dashed #d1d1d1;border-top:1px dashed #d1d1d1;">4,500,000</td>
                            </tr>
                            <tr>
                                <td style="font-size:15px;padding:5px 10px;border-top:1px dashed #d1d1d1;">Trẻ em 6-11</td>
                                <td style="font-size:15px;padding:5px 10px;text-align:right;border-left:1px dashed #d1d1d1;border-top:1px dashed #d1d1d1;">4 * 1,850,000</td>
                                <td style="font-size:15px;padding:5px 10px;text-align:right;border-left:1px dashed #d1d1d1;border-top:1px dashed #d1d1d1;">7,400,000</td>
                            </tr>
                            <tr>
                                <td style="font-size:15px;padding:5px 10px;border-top:1px dashed #d1d1d1;">Trên 60</td>
                                <td style="font-size:15px;padding:5px 10px;text-align:right;border-left:1px dashed #d1d1d1;border-top:1px dashed #d1d1d1;">6 * 2,000,000</td>
                                <td style="font-size:15px;padding:5px 10px;text-align:right;border-left:1px dashed #d1d1d1;border-top:1px dashed #d1d1d1;">12,000,000</td>
                            </tr>
                ...
                <tr>
                    <td style="box-sizing:border-box;padding:5px 15px;">
                        <table class="sendEmail" role="presentation" style="border-collapse:collapse;width:100%;line-height:1.68;font-size:15px;color:#456;border:1px solid #d1d1d1;">
                            ...
                            <tbody>
                            <tr>
                                <td style="font-size:15px;padding:5px 10px;border-top:1px dashed #d1d1d1;text-align:center;">1</td>
                                <td style="font-size:15px;padding:5px 10px;border-left:1px dashed #d1d1d1;border-top:1px dashed #d1d1d1;">PHAM THI MINH THU</td>
                                <td style="font-size:15px;padding:5px 10px;text-align:right;border-left:1px dashed #d1d1d1;border-top:1px dashed #d1d1d1;">1999</td>
                                <td style="font-size:15px;padding:5px 10px;text-align:right;border-left:1px dashed #d1d1d1;border-top:1px dashed #d1d1d1;">371552019</td>
                            </tr>
                            </tbody>
                        </table>
                        <table class="sendEmail" role="presentation" style="border-collapse:collapse;width:100%;line-height:1.68;font-size:15px;color:#456;">
