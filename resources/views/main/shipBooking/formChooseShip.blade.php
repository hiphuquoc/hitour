@if(!empty($data)&&!empty($date))
    <input id="js_chooseDeparture_dp{{ $code }}" type="hidden" name="dp{{ $code }}" value="" />
                    ...
                    <div class="chooseDepartureShipBox">
                        ...
                        <div class="chooseDepartureShipBox_body">
                            ...
                            <div class="chooseDepartureShipBox_body_row">
                                ...
                                <div class="chooseDepartureShipBox_body_row_item">
                                    <div class="option" onClick="chooseDeparture(this, {{ $code }}, '{{ $time['time_departure'] }}', 'eco');">
                                        <div>ECO</div>
                                ...
                                <div class="chooseDepartureShipBox_body_row_item">
                                    ...
                                    <div class="option" onClick="chooseDeparture(this, {{ $code }}, '{{ $time['time_departure'] }}', 'vip');">
                                        <div>VIP</div>
