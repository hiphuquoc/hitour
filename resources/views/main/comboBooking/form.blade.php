...
@section('content')
    ...
    <form id="formBooking" action="{{ route('main.comboBooking.create') }}" method="POST">
    @csrf
    ...
    <div class="pageContent">
        <div class="sectionBox">
            <div class="container">
                <!-- title -->
                <h1 class="titlePage" style="margin-bottom:0.5rem;">Đặt combo du lịch</h1>
                                        ...
                                        <div class="formColumnCustom">
                                            <div class="formColumnCustom_item">
                                                <div class="inputWithLabelInside location">
                                                    <label class="form-label" for="combo_location_id">Điểm đến</label>
                                            ...
                                            <div class="formColumnCustom_item">
                                                <div class="inputWithLabelInside">
                                                    <label class="form-label" for="combo_info_id">Chọn dịch vụ</label>
...
@push('scripts-custom')
    ...
    <script type="text/javascript">
        ...
        function loadBookingSummary(){
            ...
            $.ajax({
                url         : '{{ route("main.comboBooking.loadBookingSummary") }}',
                type        : 'get',
                dataType    : 'html',
                data        : {
                    dataForm    : dataForm
