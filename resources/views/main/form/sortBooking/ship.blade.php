...
<div class="bookFormSort_body_item">
    ...
    <div class="inputWithIcon adult">
        ...
        <div class="inputWithForm">
            <input type="text" id="js_setValueQuantityShip_idWrite" class="form-control inputWithForm_input" name="date_1" value="1 Người lớn, 0 Trẻ em, 0 Cao tuổi" readonly="readonly" required>
